...
int main(int argc, char *argv[])
{
	...
	// EDSR (x2)
	string path_x2 = "EDSR_x2.pb";
	string modelName_x2 = "edsr";
	...
	// EDSR (x3)
	string path_x3 = "EDSR_x3.pb";
	string modelName_x3 = "edsr";
	...
	// EDSR (x4)
	string path_x4 = "EDSR_x4.pb";
	string modelName_x4 = "edsr";
