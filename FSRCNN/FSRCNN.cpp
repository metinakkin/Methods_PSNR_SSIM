...
int main(int argc, char *argv[])
{
	...
	// FSRCNN (x2)
	string path_x2 = "FSRCNN_x2.pb";
	string modelName_x2 = "fsrcnn";
	...
	// FSRCNN (x3)
	string path_x3 = "FSRCNN_x3.pb";
	string modelName_x3 = "fsrcnn";
	...
	// FSRCNN (x4)
	string path_x4 = "FSRCNN_x4.pb";
	string modelName_x4 = "fsrcnn";
